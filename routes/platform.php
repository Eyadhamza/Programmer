...
use App\Orchid\Screens\Section\SectionScreen;
use App\Orchid\Screens\Tracks\TrackEditScreen;
use App\Orchid\Screens\Tracks\TrackScreen;
...
Route::screen('sections', SectionScreen::class)->name('platform.section');
Route::screen('section/{section?}', SectionEditScreen::class)->name('platform.section.edit');
